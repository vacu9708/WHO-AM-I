# 🙌소개
- 공부와 개발을 하면서 어려운 것에 막혔을때 쉽게 포기하지 않고 해결할 때까지 잠을 못 잤던 경험이 많습니다.
- 자기주도적으로 모르는 것들을 공부하려고 노력하며, 나중에 기억할 수 있도록 공부 기록을 남겨왔습니다.
- 부족한 점을 개선하기 위한 피드백 수용에 열려있습니다.
...
### [기타 튜닝기](https://github.com/vacu9708/Guitar-tuner) `2020/05, 2022/02`
...
- 친구의 요청과 피드백을 받아 지정한 웹 페이지의 업데이트 내용을 알려주는 프로그램 개발
...
- clone, pull, push, reset 등 [Git](https://github.com/vacu9708/Tools-etc/tree/main/Git)을 활용해봤음. branch를 나누고 pull request와 merge를 이용해 개발해봤음
