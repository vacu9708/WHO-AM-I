...
- [Kafka의 기본적인 내용과 쓰는 이유](https://github.com/vacu9708/Tools-etc/tree/main/Messaging%20system(Kafka))에 관해 공부했고 대규모 트래픽에서 decoupled 비동기 처리로 부하를 분산하기 위해 이메일 담당 마이크로서비스에 활용해봤습니다.
