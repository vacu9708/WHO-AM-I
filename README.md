# 🙌Introduction
- 저를 한 문장으로 요약하면 "막막하더라도 웬만하면 `포기하지 않는` 개발자"입니다. 개발을 하면서 어려운 일에 막힌 적이 많았지만 포기하지 않고 해결해내기위해 최선을 다했습니다.
- 모르면 공부해서 해내고, 부족한 점이 있으면 고치려고 하는 `열린 자세`가 중요하다고 생각합니다. 저는 `진취적으로` 모르는 것들을 공부해왔고 공부한 것들을 Github에 기록해 나중에 기억할 수 있도록 했습니다.
...
# 👨‍🎓Education
- 인천대학교, 임베디드시스템공학과, 학사 - 2021/03~2023/02 (최종 학력)
