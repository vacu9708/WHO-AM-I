...
- [Kafka를 쓰는 이유](https://github.com/vacu9708/Tools-etc/tree/main/Messaging%20system(Kafka))에 관해 공부했고 대규모 트래픽에서 decoupled 처리로 서버 부하를 분산하기 위해 이메일 담당 마이크로서비스에 활용해봤습니다. 또한, partition을 나누고 consumer group을 설정해 [로드밸런싱](https://github.com/vacu9708/Fundamental-knowledge/tree/main/Web%20development/Server-side/Service%20discovery%2C%20Load%20balancing)을 적용했습니다.
